  ...
  function () {
   ...
   --------------------------*/
    ...
    setTarget = () => {
      ...
      document.querySelector('#targetScope' + 0).style.left = (target0X + 20) + 'px';
      document.querySelector('#targetScope' + 0).style.top = (target0Y - addY + 20) + 'px';
      /*------ 照準位置決定ここまで ------*/
    }
