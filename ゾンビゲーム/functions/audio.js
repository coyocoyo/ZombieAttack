...
>>>>>>> 7a0aa4b072d8a9486b8dc365014460ddf3903386
...
document.addEventListener('DOMContentLoaded',
  function () {
    ...
    soundShoot01 = function () {
      ...
      document.querySelector('#soundShoot01').volume = 0.3; // 割とかん高い音で耳障りだった 
    ...
    soundShoot02 = function () {
      ...
      document.querySelector('#soundShoot02').volume = 0.3; // 0 ~ 1 で設定する。
    ...
    soundHit = function () {
      ...
      document.querySelector('#soundHit').volume = 0.1; // 0 ~ 1 で設定する。
    ...
    soundDestroy = function () {
      ...
      document.querySelector('#soundDestroy').volume = 1; // 0 ~ 1 で設定する。
